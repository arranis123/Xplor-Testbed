	...
	theme: {
		...
		extend: {
			...
			spacing: {
				...
				'tablet-xs': 'var(--spacing-tablet-xs)',
				'tablet-sm': 'var(--spacing-tablet-sm)',
				'tablet-md': 'var(--spacing-tablet-md)',
				'tablet-lg': 'var(--spacing-tablet-lg)',
				'tablet-xl': 'var(--spacing-tablet-xl)',
				'tablet-2xl': 'var(--spacing-tablet-2xl)',
				'touch-min': 'var(--touch-target-min)',
				'touch-comfortable': 'var(--touch-target-comfortable)',
				'touch-tablet': 'var(--touch-target-tablet)',
			},
			fontSize: {
				...
				'tablet-xs': 'var(--text-tablet-xs)',
				'tablet-sm': 'var(--text-tablet-sm)',
				'tablet-base': 'var(--text-tablet-base)',
				'tablet-lg': 'var(--text-tablet-lg)',
				'tablet-xl': 'var(--text-tablet-xl)',
				'tablet-2xl': 'var(--text-tablet-2xl)',
				'tablet-3xl': 'var(--text-tablet-3xl)',
				'tablet-4xl': 'var(--text-tablet-4xl)',
			},
			minHeight: {
