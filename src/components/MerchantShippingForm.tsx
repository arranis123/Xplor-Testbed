        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-7 mb-8">
              ...
              <TabsTrigger value="capacity-equipment">Capacity & Equipment</TabsTrigger>
            ...
            {/* Vessel Details Tab */}
            <TabsContent value="vessel-details" className="space-y-6">
              <Card>
                <CardHeader>
            ...
            {/* Capacity & Equipment Tab */}
            <TabsContent value="capacity-equipment" className="space-y-6">
              <Card>
                <CardHeader>
            ...
            <TabsContent value="location" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold mb-4">Operational Regions</h4>
                    <FormField
                      control={form.control}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Availability Port (if for charter/sale)</FormLabel>
                          <FormControl>
                            <Input placeholder="e.g., Hamburg, Germany" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    control={form.control}
                    name="typicalTradingRoute"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Typical Trading Route</FormLabel>
                        <FormControl>
                          <Textarea 
                            placeholder="Describe typical trading routes and operational areas..."
                            {...field} 
                          />
                        </FormControl>
                        <FormMessage />
