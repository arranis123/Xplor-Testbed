          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="totalYearsYachting" render={({
                    field
                  }) => <FormItem>
                    ...
                    <FormField control={form.control} name="numberOfYachts" render={({
                    field
                  }) => <FormItem>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="largestGRT" render={({
                    field
                  }) => <FormItem>
                          <FormLabel>Largest GRT Vessel Worked</FormLabel>
                          <FormControl>
                            <Input type="number" min="0" placeholder="e.g., 3000" {...field} onChange={e => field.onChange(Number(e.target.value))} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>} />
                    <FormField control={form.control} name="seaMilesLogged" render={({
                    field
                  }) => <FormItem>
                          <FormLabel>Sea Miles Logged</FormLabel>
                          <FormControl>
                            <Input type="number" min="0" placeholder="e.g., 50000" {...field} onChange={e => field.onChange(Number(e.target.value))} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>} />
                  </div>
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    <FormField control={form.control} name="atlanticCrossings" render={({
                    field
                  }) => <FormItem>
                    ...
                    <FormField control={form.control} name="mediterraneanCrossings" render={({
                    field
                  }) => <FormItem>
                    ...
                    <FormField control={form.control} name="suezTransits" render={({
                    field
                  }) => <FormItem>
                    ...
                    <FormField control={form.control} name="panamaTransits" render={({
                    field
                  }) => <FormItem>
                  ...
                  <FormField control={form.control} name="charterRevenue" render={({
                  field
                }) => <FormItem>
                        <FormLabel>Approximate Charter Revenue Generated (USD)</FormLabel>
                        <FormControl>
                          <Input type="number" min="0" placeholder="e.g., 500000" {...field} onChange={e => field.onChange(Number(e.target.value))} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                  ...
                  field
                        ...
                        <FormControl>
                          <Textarea placeholder="e.g., English (Native), Spanish (Fluent), French (Conversational)" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                </CardContent>
